...
update_service_subnets() {
    ...
    # Convert subnets to JSON array elements
    local subnets_json
    ...
    # Get and validate security groups
...
echo "✅ Script ecs-dr.sh created successfully. You can now run it with bash ecs-dr.sh --mode failover --cluster <cluster> --service <service>"
